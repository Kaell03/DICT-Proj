...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark"
        ...
        <div>
            <button class="btn btn-warning my-2 my-sm-0" type="submit" data-toggle="modal" data-target="#loginModal">Create Account</button>
            <button class="btn btn-warning my-2 my-sm-0" type="submit" data-toggle="modal" data-target="#loginModal">Generate New Record</button>
        </div>
    </nav>
