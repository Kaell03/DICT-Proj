...
<body>
    ...
    <table class="table table-hover table-bordered table-striped table-info" style="width: 95%; margin: 24px; "
        ...
        <tbody>
            <?php
            $filtervalues = "-";
            $query = "SELECT * FROM records WHERE type = 'travel_order' AND username = '$sessionUsername'";
            ...
            type = 'travel_order' AND username = '$sessionUsername' 
            AND CONCAT(id, type, control_number, name_of_personnel, designation, destination) LIKE '%$filtervalues%' ";
    ...
    <table class="table table-hover table-bordered table-striped table-info" style="width: 95%; margin: 24px;"
        ...
        <tbody>
            <?php
            $filtervalues = "_";
            $query = "SELECT * FROM records WHERE type = 'purchase_request' AND username = '$sessionUsername'";
            if (isset($_GET['search'])) {
                $filtervalues = $_GET['search'];
            }
            $number_count = 1;
            $query = "SELECT * FROM records WHERE type = 'purchase_request' AND username = '$sessionUsername'
            AND CONCAT (control_number, particulars) LIKE '%$filtervalues%'";
    ...
    <table class="table table-hover table-bordered table-striped table-info" style="width: 95%; margin: 24px;"
        ...
        <tbody>
            <?php
            $filtervalues = "_";
            $query = "SELECT * FROM records WHERE type = 'abstract_of_canvas' AND username = '$sessionUsername'";
            if (isset($_GET['search'])) {
                $filtervalues = $_GET['search'];
            }
            $number_count = 1;
